...
class Settings(BaseSettings):
    ...
    # Fallback hardcoded para que el chatbot ande aunque la env var no esté seteada.
    # Repo PRIVADO — riesgo controlado. Para rotar: cambiar acá O setear GEMINI_API_KEY
    # en Render (la env var siempre gana sobre este default).
    GEMINI_API_KEY: str = "AIzaSyBw7Y0TSaupOMCMHegSI5ldWwG3gOA4VkY"
